...
class ProjectorCamCalib
{
public:
	ProjectorCamCalib(int imgWidth, int imgHeight, int num_of_corners_horz, int num_of_corners_vert, float square_size);
	~ProjectorCamCalib(void);
